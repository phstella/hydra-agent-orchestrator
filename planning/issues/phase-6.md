# Phase 6 Tickets (Windows Parity and Release Hardening) Issue Bodies
...
- Phase: Phase 6 Tickets (Windows Parity and Release Hardening)
- Labels: hydra, phase-6, area-core, type-test
- Estimate: M
- Dependencies: M4.6
...
- Phase: Phase 6 Tickets (Windows Parity and Release Hardening)
- Labels: hydra, phase-6, area-core, type-feature
- Estimate: M
- Dependencies: M1.3
...
- Phase: Phase 6 Tickets (Windows Parity and Release Hardening)
- Labels: hydra, phase-6, area-release, type-feature
- Estimate: M
...
- Phase: Phase 6 Tickets (Windows Parity and Release Hardening)
- Labels: hydra, phase-6, area-test, type-test
- Estimate: M
...
- Expected range: `M6.1` through `M6.6`
